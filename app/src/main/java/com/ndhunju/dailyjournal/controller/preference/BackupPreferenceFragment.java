...
import com.ndhunju.dailyjournal.controller.importExport.AutoBackupAlertDialog;
import com.ndhunju.dailyjournal.controller.importExport.BackUpAsyncTask;
import com.ndhunju.dailyjournal.controller.importExport.EraseAllAsyncTask;
import com.ndhunju.dailyjournal.controller.importExport.ExportPartiesReportAsync;
import com.ndhunju.dailyjournal.controller.importExport.FetchBackUpFromGDriveAsync;
import com.ndhunju.dailyjournal.controller.importExport.GoogleApiClientManager;
import com.ndhunju.dailyjournal.controller.importExport.RestoreBackUpAsync;
import com.ndhunju.dailyjournal.controller.importExport.UploadBackUpToGDriveAsync;
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        switch (requestCode) {
            ...
            case REQUEST_CODE_PICK_JSON:     //Called when the user has picked a json file to restore data from
                ...
                JsonConverter converter = JsonConverter.getInstance(Services.getInstance(getActivity()));
